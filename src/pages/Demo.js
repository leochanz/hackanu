  ...
  (function () {
    ...
    function checkRequirements() {
      ...
      if (!Modernizr.getusermedia) {
        deferred.reject(
          "Your browser doesn't support getUserMedia (according to Modernizr)."
        );
      }
      ...
      if (Modernizr.webgl) {
        ...
        deferred.reject(
          "Your browser doesn't support WebGL (according to Modernizr)."
        );
      }
    ...
    function step3() {
      ...
      Tesseract.recognize(ctx).then(function (result) {
        ...
        spinner.hide();
        $("blockquote p").html(
          "&bdquo;" + resultText + "afdgsiboinubgyca" + "&ldquo;"
        );
